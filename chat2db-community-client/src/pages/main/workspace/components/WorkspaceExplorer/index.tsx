...
const WorkspaceExplorer = memo(
  forwardRef<WorkspaceExplorerRef, WorkspaceExplorerProps>(
    ({ active = true, onSearchKeywordChange, searchKeyword }, ref) => {
    ...
    const sessionCountLabel = trimmedSearchKeyword
      ? `${filteredOpenSessions.length}/${openSessions.length}`
      : openSessions.length;
            ...
            >
              ...
              <section className={styles.sessionSection}>
                <div className={styles.sectionHeader}>
                  ...
                  <span className={styles.sectionCount}>{sessionCountLabel}</span>
                </div>
                <div className={styles.sessionList}>
                  {!openSessions.length && (
                    <div className={styles.emptyText}>{i18n('workspace.openSessions.empty')}</div>
                  )}
