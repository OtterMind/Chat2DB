...
assertCapability(DatabaseTypeCode.MYSQL, DatabaseCapability.MANUAL_TRANSACTIONS, true);
assertCapability(DatabaseTypeCode.POSTGRESQL, DatabaseCapability.MANUAL_TRANSACTIONS, false);
