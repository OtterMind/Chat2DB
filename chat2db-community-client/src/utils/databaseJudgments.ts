...
export const shouldShowMysqlForeignKeyEditor = (databaseType?: DatabaseTypeInput): boolean => {
  return containsStrict(databaseCapabilities.tableEditorMysqlForeignKeySupported, databaseType);
};
