export default {
  ...
  'editTable.tips.prefixLengthUnsupported': 'La longitud del prefijo solo se admite para columnas de texto o binarias',
  'editTable.tips.prefixLengthTooLarge': 'La longitud del prefijo no puede superar la longitud de la columna ({1})',
  'editTable.tips.rebuildIndexWarning': 'Reconstruir un indice puede bloquear la tabla y tardar en tablas grandes.',
