export default {
  ...
  'common.explain.planTree': 'プランツリー',
  'common.explain.rawJson': '未加工 JSON',
  'common.explain.rawOutput': '未加工出力',
  'common.explain.noPlanNodes': 'プランノードが見つかりません',
  'common.explain.source': 'ソース',
  'common.explain.analyzeWarning': 'EXPLAIN ANALYZE は実際の時間を表示する前に選択したクエリを実行します。',
  'common.explain.jsonUnsupported': 'EXPLAIN FORMAT=JSON には MySQL 5.7 以降が必要です',
  'common.explain.analyzeUnsupported': 'EXPLAIN ANALYZE には MySQL 8.0.18 以降が必要です',
  'common.explain.analyzeUnsupportedWithVersion': 'EXPLAIN ANALYZE には MySQL 8.0.18 以降が必要です。現在のバージョン: {1}',
  'common.explain.cancelled': 'EXPLAIN リクエストをキャンセルしました',
  ...
  'common.menu.main': 'メインメニュー',
  'common.menu.view': '表示',
  'common.menu.help': 'ヘルプ',
  'common.menu.openLog': 'ログを開く',
