export default {
  ...
  'common.explain.planTree': 'Plan tree',
  'common.explain.rawJson': 'Raw JSON',
  'common.explain.rawOutput': 'Raw output',
  'common.explain.noPlanNodes': 'No plan nodes were found',
  'common.explain.source': 'Source',
  'common.explain.analyzeWarning': 'EXPLAIN ANALYZE executes the selected query before showing actual timing.',
  'common.explain.jsonUnsupported': 'EXPLAIN FORMAT=JSON requires MySQL 5.7 or later',
  'common.explain.analyzeUnsupported': 'EXPLAIN ANALYZE requires MySQL 8.0.18 or later',
  'common.explain.analyzeUnsupportedWithVersion': 'EXPLAIN ANALYZE requires MySQL 8.0.18 or later. Current version: {1}',
  'common.explain.cancelled': 'EXPLAIN request cancelled',
  ...
  'common.menu.main': 'Main menu',
  'common.menu.view': 'View',
  'common.menu.help': 'Help',
  'common.menu.openLog': 'Open log',
