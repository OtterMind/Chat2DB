...
const PartitionsContent = ({
  ...
  const load = useCallback(() => {
    ...
    setError(null);
    sqlService
      .getPartitionList({ databaseName, tableName })
                ...
                <Button
                  ...
                  onClick={() =>
                    confirmAndExecute(
                      ...
                      sqlService.getPartitionDropSql({ databaseName, tableName, partitionName: r.partitionName! }),
                      true,
                    )
                  }
                >
                ...
                <Button
                  ...
                  onClick={() =>
                    confirmAndExecute(
                      ...
                      sqlService.getPartitionTruncateSql({ databaseName, tableName, partitionName: r.partitionName! }),
                      true,
                    )
                  }
                >
            ...
            <Button
              ...
              onClick={() =>
                confirmAndExecute(
                  ...
                  sqlService.getPartitionCoalesceSql({ databaseName, tableName, count: coalesceCount }),
                  false,
                )
              }
            >
