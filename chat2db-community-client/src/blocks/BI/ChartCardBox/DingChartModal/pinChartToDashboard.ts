 ...
 * because `refreshCurrentDashboard` resolves to `false` on failure. Request
 * errors are already reported by the global response interceptor, so this
 * handler settles with `false` instead of rejecting and always clears the
