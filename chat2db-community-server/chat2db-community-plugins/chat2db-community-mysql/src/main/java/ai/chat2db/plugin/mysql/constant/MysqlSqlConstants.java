...
public final class MysqlSqlConstants {
    ...
    public static final String SQL_DROP_FOREIGN_KEY = "DROP FOREIGN KEY ";
    public static final String SQL_ADD_CONSTRAINT = "ADD CONSTRAINT ";
    public static final String SQL_FOREIGN_KEY_PREFIX = "FOREIGN KEY (";
    public static final String SQL_REFERENCES = ") REFERENCES ";
    public static final String SQL_ON_DELETE = " ON DELETE ";
    public static final String SQL_ON_UPDATE = " ON UPDATE ";
