...
@JcefAction(value = "kill-terminal", method = "client-command")
public class KillTerminalHandler implements IJcefActionHandler {
    @Override
    public void handle(ConsoleMessage consoleMessage, ConsoleResult wsResult, CefQueryCallback callback) {
        ...
        TerminalSessionManager.kill(request.getString("sessionId"));
