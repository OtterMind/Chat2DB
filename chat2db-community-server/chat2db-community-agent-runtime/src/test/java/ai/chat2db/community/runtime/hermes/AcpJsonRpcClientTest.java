...
class AcpJsonRpcClientTest {
    ...
    void pausesRequestTimeoutWhileApprovalIsPending() throws Exception {
        ...
        try (AcpJsonRpcClient client = new AcpJsonRpcClient(mapper, clientInput, clientOutput,
                ignored -> { }, (id, method, params) -> mapper.createObjectNode(), ignored -> { })) {
            JsonNode result = client.request("session/prompt", mapper.createObjectNode(),
