...
public final class JdbcDriverConstants {
    ...
    /**
     * @deprecated Use {@link #getDriverUploadPath()} so the path reflects the active runtime home.
     */
    @Deprecated
    public static final String DRIVER_UPLOAD_PATH = getDriverUploadPath();
    ...
    public static String getDriverUploadPath() {
        return getDriverLibPath() + ".uploads" + File.separator;
    }
